...
//453681/1654832/2.50/10/2/Connector
...
(library Library_1
	...
	(patternDef "1991341" (originalName "1991341")
		(multiLayer
			...
			(pad (padNum 5) (padStyleRef c195_h130) (pt 20.32, 0) (rotation 90))
			(pad (padNum 6) (padStyleRef c195_h130) (pt 25.4, 0) (rotation 90))
			(pad (padNum 7) (padStyleRef c195_h130) (pt 30.48, 0) (rotation 90))
			(pad (padNum 8) (padStyleRef c195_h130) (pt 35.56, 0) (rotation 90))
			(pad (padNum 9) (padStyleRef c195_h130) (pt 40.64, 0) (rotation 90))
			(pad (padNum 10) (padStyleRef c195_h130) (pt 45.72, 0) (rotation 90))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0, 0) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.54 4.75) (pt 48.26 4.75) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 48.26 4.75) (pt 48.26 -4.75) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 48.26 -4.75) (pt -2.54 -4.75) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.54 -4.75) (pt -2.54 4.75) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt -2.54 4.75) (pt 48.26 4.75) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt 48.26 4.75) (pt 48.26 -4.75) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt 48.26 -4.75) (pt -2.54 -4.75) (width 0.1))
		)
		(layerContents (layerNumRef 18)
			(line (pt -2.54 -4.75) (pt -2.54 4.75) (width 0.1))
		)
		(layerContents (layerNumRef 18)
		...
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -4.25 5.75) (pt 49.26 5.75) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 49.26 5.75) (pt 49.26 -5.75) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 49.26 -5.75) (pt -4.25 -5.75) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -4.25 -5.75) (pt -4.25 5.75) (width 0.05))
		)
	)
	(symbolDef "1991341" (originalName "1991341")
	...
	(compDef "1991341" (originalName "1991341") (compHeader (numPins 10) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "1991341"))
		(attachedPattern (patternNum 1) (patternName "1991341")
			(numPads 10)
			(padPinMap
		...
		(attr "Mouser Part Number" "651-1991341")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Phoenix-Contact/1991341?qs=MfVUZiz0PxYqEbuQrw2QtQ%3D%3D")
		(attr "Manufacturer_Name" "Phoenix Contact")
		(attr "Manufacturer_Part_Number" "1991341")
		(attr "Description" "PCB terminal block, nominal current: 24 A, rated voltage (III/2): 400 V, nominal cross section: 2.5 mm?, Number of potentials: 10, Number of rows: 1, Number of positions per row: 10, product range: MKDSN 2,5, pitch: 5.08 mm, connection method: Screw connection with tension sleeve, mounting: Wave soldering, conductor/PCB connection direction: 0 ?, color: green, Pin layout: Linear pinning, Solder pin [P]: 3.5 mm, type of packaging: packed in cardboard. The article can be aligned to create different nos. of po")
		(attr "<Hyperlink>" "http://www.phoenixcontact.com/de/produkte/1991341/pdf")
		(attr "<Component Height>" "15.15")
		(attr "<STEP Filename>" "1991341.stp")
		(attr "<STEP Offsets>" "X=48.3;Y=-4.75;Z=-1.5")
